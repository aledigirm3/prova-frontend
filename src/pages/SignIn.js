...
function SignIn () {
  ...
  const handleForgotPassword = () => {
    ...
    axios.post(`${config.api.uri}/auth/actions/forgotpassword`, { email }, { withCredentials: true })
      .then(() => {
        setEmail('')
  ...
  return (
    <div>
     ...
     <button type="button" className="btn btn-light" style={{ marginLeft: '40%' }} data-mdb-ripple-color="dark" data-mdb-toggle="modal" data-mdb-target="#exampleModal">
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">Recupera password</h5>
      ...
      <div className="modal-footer">
        <button type="button" className="btn btn-secondary" data-mdb-dismiss="modal" onClick={e => setEmail('')}>Close</button>
        <button type="button" className="btn btn-primary" data-mdb-dismiss="modal" onClick={handleForgotPassword}>Invia mail</button>
       </div>
      </div>
     </div>
   </div>
